...
class PARSIMKAlgorithm(IdentificationAlgorithm):
    """
    PARSIM-K (Partially Realizable State Space with Kalman gain) algorithm.
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs: Algorithm parameters
                ...
                - ss_pk_b_reval: Whether to re-evaluate B matrix (default: False)
